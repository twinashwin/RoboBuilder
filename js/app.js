...
(function () {
  ...
  window.addEventListener('load', () => {
    ...
    // Splash
    const _splashLoginBtn = document.getElementById('btn-splash-login');
    if (_splashLoginBtn) {
      _splashLoginBtn.addEventListener('click', () => {
    ...
    if (loginBtn) {
      ...
      const openAccountMenu = () => {
        ...
        _accountMenu.setAttribute('role', 'menu');
        _accountMenu.innerHTML =
          '<div class="account-menu-email" title="' + email.replace(/"/g, '&quot;') + '">' + email + '</div>' +
          '<button type="button" class="account-menu-item account-menu-item-primary" id="account-menu-details" role="menuitem">' +
          ...
          '<button type="button" class="account-menu-item account-menu-item-signout" id="account-menu-signout" role="menuitem">' +
        ...
        document.getElementById('account-menu-details').addEventListener('click', () => {
          closeAccountMenu();
          if (window._showAccountModal) window._showAccountModal();
        });
